    ...
    <v-row class="px-2 py-2 mt-2">
          ...
          <v-col cols="12" md="12" class="mt-2 text-center">
            <v-table >
              <thead>
                <tr>
                  <th  class="mt-2 text-center" >Prénom nom, fonction</th>
                  <th  class="mt-2 text-center">Signature</th>
                </tr>
                <tbody class="mt-2 mx-auto text-center">
                  <tr v-for="conseiller in conseillerMunicipalStore.conseillers">
                    <th  class="mt-2 mx-auto w-100 text-center">{{ conseiller.prenom}} {{ conseiller.nom }} , {{conseiller.role}}</th>
                    <th></th>
                  </tr>
                </tbody>
